  ...
  return (
    <div>
         ...
         <form onSubmit={handlesubmit}>
           ...
           <textarea className="text-area" value={props.value}   onChange={setUserInput}/>
...
const mapDispatchToProps = dispatch =>{
  return{
    ...
    getName:(event)=>
    dispatch(actionCreator.getName(event.target.value)),
     getData:(name)=>
      dispatch(actionCreator.getData(name)),
  }
}
